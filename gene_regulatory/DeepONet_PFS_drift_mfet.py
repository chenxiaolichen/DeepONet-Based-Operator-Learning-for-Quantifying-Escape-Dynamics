...
data_dir = r"G:\gene\PFS\drift\met"
...
def generate_one_sample(P):
    ...
    f_fn = lambda x: chebyshev_polynomial(x, n_cheb, coeffs)
...
def generate_batch_data(N, P):
    pbar = trange(N, desc=f"{N} data samples")
